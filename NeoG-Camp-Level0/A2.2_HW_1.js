...
console.log("Is Akshay Faster than Ravi in the 400m sprint? ", isAkshayFaster400)
...
console.log("Did Akshay make a longer throw than Ravi? ", isAkshayLongerJump)
...
console.log("Did Akshay make a jump higher than Ravi? ", isAkshayHigherJump)
...
totalPrice = milkPrice + breadPrice
areBothUnderBudget = budget > totalPrice
...
minimumAverage = 60
averageScore = (gangaCricketClubScore + yamunaCricketClubScore + narmadaCricketClubScore + godavariCricketClubScore) / 4
isSelected = minimumAverage < averageScore
...
isDivisibleBy4 = numberofStudents % 4 === 0
isDivisibleBy9 = numberofStudents % 9 === 0
